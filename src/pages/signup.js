...
import { Container, Typography, Box, TextField, InputLabel, MenuItem, FormControl, Select } from "@material-ui/core"
        ...
        <Container className={classes.root}>
            <main className={classes.main}>
                <section className={classes.section1}>
                    <Typography>General Infomation</Typography>
                    ...
                    >
                        ...
                        <div>
                            <TextField id="user-email" label="Email Address" variant="standard" />
                        </div>
                        <div>
